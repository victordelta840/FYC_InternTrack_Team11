...
if (!templateData) {
  return <AppShell role="ADMIN">Loading template...</AppShell>;
}

const isImage = templateData.format !== 'PDF';

return (
    <AppShell role="ADMIN">
      <h1 className="font-display text-3xl">Map Fields · {templateData.name}</h1>
